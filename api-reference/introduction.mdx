---
title: 'API Reference'
description: 'Complete reference for ScaleX DEX API endpoints and data structures'
---

# ScaleX DEX API Reference

The ScaleX DEX API provides comprehensive access to market data, trading information, and user account details. Built on a high-performance indexer, our API delivers real-time and historical data for all trading pairs and user activities.

## Base URL

```
https://api.scalex.money
```
...
For real-time data streams, ScaleX DEX also provides WebSocket connections:
...
Ready to start building with ScaleX DEX? Check out our [quickstart guide](/quickstart) or dive into the [endpoint documentation](/api-reference/endpoints/markets).