---
title: 'WebSocket API'
description: 'Real-time data streams and WebSocket integration for ScaleX DEX'
---
...
```typescript ScaleX WebSocket Client
import WebSocket from 'ws';

class ScaleXWebSocketClient {
  ...
  constructor(
    private url: string = 'wss://ws.scalex.money',
...
// Usage
const wsClient = new ScaleXWebSocketClient();
...
class ScaleXWebSocketClient:
    def __init__(self, url: str = "wss://ws.scalex.money", api_key: Optional[str] = None, api_secret: Optional[str] = None):
        self.url = url
...
# Usage
async def main():
    ws_client = ScaleXWebSocketClient()
...
class StreamAggregator {
  ...
  constructor(private wsClient: ScaleXWebSocketClient) {}
...
```typescript
class RobustWebSocketClient extends ScaleXWebSocketClient {
